...
namespace Crypto_BankingREG.Controllers
{
    ...
    public class ApplicationUserController : ControllerBase
    {
        ...
        public ApplicationUserController(UserManager<ApplicationUser> userManager, ApplicationUserService user, ILogger<ApplicationUserController> logger, IPasswordHasher<ApplicationUser> passwordHash)
        {
